...
_Generated by `./gradlew :editor:generatePuppeteerDocsScreenshots` on 2026-03-06 20:07._
...
| `PIVOT_X` | `pivotX` | Pivot X | 0 | 0 – 1 | Horizontal origin (0 = left, 1 = right) |
| `PIVOT_Y` | `pivotY` | Pivot Y | 0 | 0 – 1 | Vertical origin (0 = top, 1 = bottom) |
...
- **Easing** — dropdown with all 26 easing types
...
26 built-in easing curves + custom cubic Bézier:
...
- **Ctrl+Scroll** on timeline — zoom horizontally (0.05x to 2.0x pixels/ms)
...
Click **Copy Code** (or **Cmd+C**) to copy the generated JES timeline code to the system clipboard.
