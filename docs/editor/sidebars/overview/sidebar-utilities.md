...
Complete reference for all 14 sidebar panels available in the JVN editor. Each panel has its own dedicated sub-document with full details, examples, and usage guides.
...
2. A "New Panel" chooser tab opens listing all 14 available panels
