...
│  Menu Graph / Flow                             │
│  my-project                                    │
│  [Refresh] [Validate] [Save Screen] [Save All] │
│  [Auto Layout] [Open Screen] [Add Screen]      │
│  ──────────────────────────────────────────     │
├──────────┬─────────────────────────────────────┤
│          │                                     │
│  Graph   │   ┌──────────┐     ┌──────────┐    │
│  Canvas  │   │  main    │────→│ settings │    │
│          │   │ 4 items  │     │ 3 items  │    │
│          │   └──────────┘     └──────────┘    │
│          │        │                ↑           │
│          │        ↓                │           │
...
│          │   └──────────┘                      │
├──────────┴─────────────────────────────────────┤
│  Item Table (selected screen)                  │
│  ID       │ Label      │ Action    │ Target    │
│  new_game │ New Game   │ START_GAME│           │
│  load     │ Load Game  │ OPEN_MENU │ load      │
│  settings │ Settings   │ OPEN_MENU │ settings  │
│  quit     │ Quit       │ QUIT      │           │
├────────────────────────────────────────────────┤
│  Diagnostics                                   │
