...
A progressive tutorial series that builds increasingly complex VNS scripts — from a single dialogue line to a full multi-route visual novel with variables, branching, audio, effects, character choreography, and JES integration.
...
| 6 | [Screen Effects and Timing](vns-by-example/06-effects-and-timing.md) | `[screen shake]`, `[screen flash]`, `[wait]`, `[textspeed]`, `[ui]`, `[hud]` |
