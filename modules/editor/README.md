...
- **Sidebar Panels** — Project Explorer, Story Map, Inspector, Asset Browser, Label Flow Map, VNS Diagnostics, Layered Image Visualizer, Image Attributes/Tint Tools, Layout Launcher, Puppeteer Launcher, and Version Control (Git)
