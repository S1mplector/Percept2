...
class AppBuildInfoTest {
  ...
  void displayVersionLabelUsesFallbackForDev() {
    assertEquals("v0.4.3.1", AppBuildInfo.displayVersionLabel("dev"));
    assertEquals("v0.4.3.1", AppBuildInfo.displayVersionLabel("vdev"));
    assertEquals("v0.4.3.1", AppBuildInfo.displayVersionLabel(""));
  }

  @Test
  void displayVersionLabelMapsSnapshotToAlpha() {
    assertEquals("v0.4.3.1 Alpha", AppBuildInfo.displayVersionLabel("0.4.3.1-SNAPSHOT"));
  }
