 ...
 */
final class AssetDimensionProbe {
  private AssetDimensionProbe() {}

  static Optional<double[]> dimensionsOf(AssetCatalog assets, String path) {
    return dimensionsOf(assets, path, null);
  }

  static Optional<double[]> dimensionsOf(AssetCatalog assets, String path, File projectRoot) {
