...
public record MenuLayoutSpec(
  ...
  public MenuLayoutSpec(String id, double listYStart, double lineHeight,
    ...
    this(id, listYStart, lineHeight, listWidthFactor, textAlign, hintsBottomMargin, titleY, null, null, null, "center", "center", null);
  }
  ...
  public MenuLayoutSpec(String id, double listYStart, double lineHeight,
    ...
    this(id, listYStart, lineHeight, listWidthFactor, textAlign, hintsBottomMargin, titleY, listXCenter, titleX, maxVisibleItems, "center", "center", null);
  }
