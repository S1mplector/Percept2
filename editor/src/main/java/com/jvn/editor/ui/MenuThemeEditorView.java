...
public class MenuThemeEditorView extends BorderPane {
  ...
  private File themeFile() {
    ...
    File configured = resolvePathFromManifest("menuTheme", "config/menu/theme/menu.theme");
    if (configured.exists()) return configured;
    // Compatibility with older projects.
    File legacyNested = new File(projectRoot, "config/menu/menu.theme");
    if (legacyNested.exists()) return legacyNested;
